                    ...
                    <v-img src="https://cdn.vuetifyjs.com/images/lists/ali.png" height="300px">
                        <v-layout column fill-height>
                            <v-card-title>
                                <v-tooltip bottom>
                                    <template v-slot:activator="{ on }">
                                        <v-btn icon @click="modalDetalleNomina({nomina: null, estado: false})" v-on="on">
                            ...
                            <v-card-title class="white--text pl-7 pt-12">
                                <div class="display-1 pl-7 pt-12">Nómina {{nomina.id}}</div>
                            </v-card-title>
                        </v-layout>
                    </v-img>
                    <v-container fluid>
                        <v-list>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{nomina.empleado}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            ...
                            <v-list-item>
                                <v-list-item-icon>
                                    <v-icon color="secondary">assignment_late</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">Estado de la nómina: </span>
                                        <span class="text-capitalize">{{nomina.estado}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">Precio total de la nómina: </span>
                                        <span class="text-capitalize">{{nomina.total}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">Descripción de la nómina: </span>
                                        <span class="text-capitalize">{{nomina.descripcion}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{nomina.registro}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                <v-list-item-icon>
                                    <v-icon color="secondary">vertical_split</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">Operaciones realizadas: </span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
