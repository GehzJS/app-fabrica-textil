                    ...
                    <v-img src="https://cdn.vuetifyjs.com/images/lists/ali.png" height="300px">
                        <v-layout column fill-height>
                            <v-card-title>
                                <v-tooltip bottom>
                                    <template v-slot:activator="{ on }">
                                        <v-btn icon @click="modalDetalleEmpleado({empleado: null, estado: false})" v-on="on">
                            ...
                            <v-card-title class="white--text pl-7 pt-12">
                                <div class="display-1 pl-7 pt-12">{{empleado.empleado}}</div>
                            </v-card-title>
                        </v-layout>
                    </v-img>
                    <v-container fluid>
                        <v-list>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.nombre}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.apellido_p}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.apellido_m}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                <v-list-item-icon>
                                    <v-icon color="error">work</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">Cargo del empleado: </span>
                                        <span class="text-capitalize">{{empleado.cargo}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.correo}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.telefono}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        <span class="font-weight-bold">¿Es usuario?: </span>
                                        <span class="text-capitalize">{{empleado.es_usuario}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                            <v-divider inset></v-divider>
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>
                                        ...
                                        <span class="text-capitalize">{{empleado.registro}}</span>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
