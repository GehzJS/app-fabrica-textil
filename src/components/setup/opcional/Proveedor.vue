<template>
    <div>
        <v-card flat class="mb-5" height="55vh">
            <v-card-text>
                <v-container grid-list-md>
                    <h6 class="text-center display-1 mb-5">Registre su primer proveedor</h6>
                    <p class="body-1">Los registros de proveedores le ayudan a mantener a la mano la información que usted necesita, a sólo unos clicks de distancia. Además, son usados para crear las
                        <span class="font-weight-bold">facturas de adquisición</span>.</p>
        ...
        <v-btn text rounded large color="success" @click="cambiarPagina({tipo: false, pagina: 4})" class="mb-1">
